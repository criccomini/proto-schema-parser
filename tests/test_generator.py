...
def test_trailing_comments_exhaustive_complex_schema_generator():
    ...
    # Ensure all markers are present in the generator output (order-sensitive check can
    # be added later; for now we assert presence which will still reveal gaps).
