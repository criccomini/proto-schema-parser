...
The library also supports [protobuf editions](https://protobuf.dev/programming-guides/editions/), which provide more flexibility than proto2/proto3 syntax:
...
Supported editions:
- `edition = "2023";` - [Edition 2023 spec](https://protobuf.dev/reference/protobuf/edition-2023-spec/)
- `edition = "2024";` - [Edition 2024 spec](https://protobuf.dev/reference/protobuf/edition-2024-spec/)
